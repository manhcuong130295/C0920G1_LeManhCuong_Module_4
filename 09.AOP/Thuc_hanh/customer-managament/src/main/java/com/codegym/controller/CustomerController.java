...
public class CustomerController {
    ...
    public String listCustomer(Model model,@PageableDefault(size = 3) Pageable pageable,
                               @RequestParam Optional<String> keyword) throws Exception {
    ...
    @GetMapping("/{id}/edit")
    public String formEdit(@PathVariable int id, Model model) throws Exception {
    ...
    public String detailCustomer(@PathVariable int id, Model model) throws Exception {
